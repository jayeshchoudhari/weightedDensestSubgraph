...
public:
	...
	void exec_op(bool is_add, bool is_report, unsigned int size_ds,
	        double density, double upperbound, unsigned int timestamp, std::string label);
	void end_op();
