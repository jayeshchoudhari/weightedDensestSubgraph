		...
		if (getline(graphFile, line))
		{
			...
			while(getline(graphFile, line))
			{
				...
				else if(insDel == '=')
				{
					...
					outFile << " " << estimatedDensity << " " << denseSubgraphSize << " " << (maxPartitionedDensity.first * 1.0)/localAlpha << " " << maxPartitionedDensity.second << " " << totalProcessedEdges << " " << edgeAdditions << endl;
				}
